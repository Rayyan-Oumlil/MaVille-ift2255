...
class StpmControllerTest {
    ...
    @BeforeEach
    void setUp() {
        prestataireTest = new Prestataire("1234567890", "Entreprise Test", 
    ...
    void testValiderCandidature_NotFound() throws Exception {
        ...
        // Act & Assert
        // Le contrôleur retourne notFound().build() sans body, donc pas de champ error
    ...
    void testConsulterProblemes_Success() throws Exception {
        // Note: L'endpoint /api/stpm/problemes n'existe pas dans StpmController
    ...
    void testConsulterNotifications_Success() throws Exception {
        // Note: L'endpoint /api/stpm/notifications n'existe pas dans StpmController
        // Ce test est désactivé car l'endpoint n'est pas implémenté
        // Act & Assert
