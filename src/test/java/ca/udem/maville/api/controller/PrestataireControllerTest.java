...
class PrestataireControllerTest {
    ...
    void testSoumettreCandidature_Success() throws Exception {
        ...
        requestData.put("prestataireId", "NEQ123456789"); // Le contrôleur attend "prestataireId" pas "neq"
    ...
    void testConsulterProjets_Success() throws Exception {
        ...
        // Act & Assert
        mockMvc.perform(get("/api/prestataires/NEQ123456789/projets"))
                .andExpect(status().isOk())
    ...
    void testConsulterNotifications_Success() throws Exception {
        ...
        // Act & Assert
        mockMvc.perform(get("/api/prestataires/NEQ123456789/notifications"))
